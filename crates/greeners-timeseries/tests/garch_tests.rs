use greeners_timeseries::garch::EGARCH;
use greeners_timeseries::garch::GARCH;
use greeners_timeseries::garch::GJRGARCH;
use ndarray::Array1;
...
fn test_garch_11_normal() {
    ...
    assert_eq!(
        result.model_type,
        greeners_timeseries::garch::GarchModelType::GARCH
    );
    assert_eq!(result.dist, greeners_timeseries::garch::GarchDist::Normal);
...
fn test_garch_11_student_t() {
    ...
    assert_eq!(result.dist, greeners_timeseries::garch::GarchDist::StudentT);
...
fn test_egarch() {
    ...
    assert_eq!(
        result.model_type,
        greeners_timeseries::garch::GarchModelType::EGARCH
    );
    assert_eq!(result.params.len(), 5);
    assert!(result.log_likelihood.is_finite());
...
fn test_gjr_garch() {
    ...
    assert_eq!(
        result.model_type,
        greeners_timeseries::garch::GarchModelType::GJRGARCH
    );
    assert_eq!(result.params.len(), 5);
    assert!(result.params[1] > 0.0);
    assert!(result.params[2] >= 0.0);
