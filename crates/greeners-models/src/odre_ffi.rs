...
///
/// # Safety
/// `ptr` must have been returned by `odre_execute` and must not be used after this call.
#[no_mangle]
pub unsafe extern "C" fn odre_free(ptr: *mut c_char) {
    if !ptr.is_null() {
