use crate::{
    bspline::BSplineBasis, column::CategoricalColumn, column::Column, formula::Formula,
    GreenersError,
};
...
impl DataFrame {
    ...
    /// # Examples
    /// ```
    /// use greeners_core::{DataFrame, Column};
    /// use ndarray::Array1;
    /// use indexmap::IndexMap;
    ///
    /// let mut data = IndexMap::new();
    ...
    /// # Examples
    /// ```
    /// use greeners_core::{DataFrame, Column, DataType};
    ///
    ...
    pub fn to_design_matrix(
        ...
        for var_name in &formula.independents {
            ...
            // Function transforms: log(var), exp(var), sqrt(var)
                ...
                let basis = BSplineBasis::generate(&col_data, df, degree)?;
                for j in 0..df {
                    for i in 0..n_rows {
    ...
    /// # Examples
    /// ```no_run
    /// use greeners_core::{DataFrame, TypeInferenceConfig, ColumnType};
    /// use std::collections::HashMap;
    ///
