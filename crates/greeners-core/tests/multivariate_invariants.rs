use greeners_core::multivariate::CanCorr;
use greeners_core::multivariate::FactorAnalysis;
use greeners_core::multivariate::Rotation;
use greeners_core::multivariate::MANOVA;
