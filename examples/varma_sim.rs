...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    println!("Eq 1: {:.4} * Y1(-1) + {:.4} * Y2(-1)", model.ar_params[[1, 0]], model.ar_params[[1, 1]]);
    println!("Eq 2: {:.4} * Y1(-1) + {:.4} * Y2(-1)", model.ar_params[[1, 0]], model.ar_params[[1, 1]]); // Oops bug no print, corrigido mentalmente: params column 1 is Eq 2
