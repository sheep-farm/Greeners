...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let y_data = vec![
        // Firm 1 (10 obs)
        12.5, 13.2, 14.1, 13.8, 14.5, 15.2, 14.9, 15.5, 16.1, 16.8,
        // Firm 2 (10 obs)
        10.2, 10.8, 11.5, 11.2, 12.1, 12.8, 12.5, 13.2, 13.9, 14.5,
        // Firm 3 (10 obs)
        15.5, 16.2, 16.9, 16.5, 17.2, 17.9, 17.5, 18.2, 18.9, 19.5,
        // Firm 4 (10 obs)
        8.5, 9.1, 9.8, 9.4, 10.1, 10.8, 10.4, 11.1, 11.8, 12.4,
        // Firm 5 (10 obs)
    ...
    let x1_data = vec![
        // Firm 1
        2.0, 2.1, 2.3, 2.2, 2.4, 2.6, 2.5, 2.7, 2.9, 3.0,
        // Firm 2
        1.5, 1.6, 1.8, 1.7, 1.9, 2.1, 2.0, 2.2, 2.4, 2.5,
        // Firm 3
        2.5, 2.6, 2.8, 2.7, 2.9, 3.1, 3.0, 3.2, 3.4, 3.5,
        // Firm 4
        1.0, 1.1, 1.3, 1.2, 1.4, 1.6, 1.5, 1.7, 1.9, 2.0,
        // Firm 5
    ...
    let x2_data = vec![
        // Firm 1
        1.5, 1.6, 1.7, 1.6, 1.8, 1.9, 1.8, 2.0, 2.1, 2.2,
        // Firm 2
        1.2, 1.3, 1.4, 1.3, 1.5, 1.6, 1.5, 1.7, 1.8, 1.9,
        // Firm 3
        2.0, 2.1, 2.2, 2.1, 2.3, 2.4, 2.3, 2.5, 2.6, 2.7,
        // Firm 4
        0.8, 0.9, 1.0, 0.9, 1.1, 1.2, 1.1, 1.3, 1.4, 1.5,
        // Firm 5
    ...
    println!("══════════════════════════════════════════════════════════════════════════════");
    let ols_clustered = OLS::from_formula(
        &formula,
        &df,
        CovarianceType::Clustered(cluster_ids),
    )?;
    ...
    println!("══════════════════════════════════════════════════════════════════════════════");
    println!("{:<15} | {:>12} | {:>12} | {:>12}", "Variable", "Non-Robust", "HC1", "Clustered");
    println!("{:-<15}-+-{:-<12}-+-{:-<12}-+-{:-<12}", "", "", "", "");
